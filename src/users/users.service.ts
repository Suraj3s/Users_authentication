...
export class UsersService {
  ...
  async create(createUserDto: verify_identity, logo_Image: any): Promise<any> {
  ...
  async login(Login_user: Login_identity): Promise<any> {
    ...
    const User_info = {
      ...
      User_logo: User_exist.User_logo,
      User_age: User_exist.User_age,
      permission: User_exist.permission,
    };
    if (User_exist && isMatch) {
      return {
